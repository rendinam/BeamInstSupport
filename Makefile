...
#-----------------------------------------------------------------------------
LIB_SRC_DIRS  := actions communication comm_code commstruct_output cesr_intf file_io user_io system utils
OBJ_SRC_DIRS  :=
CONFIG_DIRS   :=
LOCAL_INCS    := include comm_include cesr_intf_include hardware_include ../c_utils/include ../cfortran/include ../mpmnet/include ../cbi_net/include ../cbpmfio/include
SRC_EXCLUDE   :=
M_FILE_LIST   :=
...
LIB_DEPENDS    := c_utils mpmnet cbi_net
